...
const PerfilesOpciones = () => {
  return (
    <div id='perfil-opciones' className='absolute top-16 right-12 w-64 h-auto hidden  transition-all ease-out duration-700'>
            
    <div className='w-56 h-full m-auto mt-1 border-[1px] border-zinc-600 relative ' style={{ backgroundColor: "rgba(0,0,0,0.8)" }}>
      <div id='perfiles' className='flex flex-col gap-2 p-2 '>
        ...
        <div className='flex items-center text-xs gap-2'>
          <img src="https://occ-0-2025-185.1.nflxso.net/dnm/api/v6/K6hjPJd6cR6FpVELC5Pd6ovHRSk/AAAABe1R3ZpAl1zwvOwyGTsBdHOtyXSpIgzMIaUUWSQG0SHMS7qM1KiN4DWvSoiw82GAn4kWpN5bDcfQY8ojIdz6Q1a-AdxuJ6o.png?r=15e" alt="" width={32} className='rounded-sm cursor-pointer' />
          <span>Ismael Rosas</span>
        </div>

        <div className='flex items-center text-xs gap-2'>
          <img src="https://occ-0-2025-185.1.nflxso.net/dnm/api/v6/K6hjPJd6cR6FpVELC5Pd6ovHRSk/AAAABYjI4gI4uYLlrsWX_wCOYrqucEf06Q23MdvEJ0fm8PGB6CvE9cv-WgfV057tlJFtyg7_9hGxLxcbEt7jTZRDQIhDWwGTrH8.png?r=ab6" alt="" width={32} className='rounded-sm cursor-pointer' />
          <span>Ludovika</span>
        </div>
      ...
      <div className='w-full border-t-[1px] border-zinc-600 p-3 text-center text-white'>
...
export default PerfilesOpciones;